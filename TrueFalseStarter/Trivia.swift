...
//  TrueFalseStarter
//
//  Created by Bogdan Kireeve on 24/12/2017.
...
struct Trivia {
    ...
    let question5 = [
        ...
        "Answer": "Option 4"]
    let question6 = [
        "Question": "Which country has the most recently won consecutive World Cups in soccer?",
        "Option 1": "Italy",
        "Option 2": "Brazil",
        "Option 3": "Argentina",
        "Option 4": "Spain",
    ...
    let question8 = [
        ...
        "Answer": "Option 1"]
    let question9 = [
        "Question": "Which country was the first to allow women to vote at national elections?",
        "Option 1": "Poland",
